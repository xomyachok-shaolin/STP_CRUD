...
<div class="container">
    ...
    <div class="header">
        ...
        <div id="navbar">
            ...
            <a href="pages/numbers.php">Номера</a>
            <a href="pages/clients.php">Клиенты</a>
        </div>

    </div>

    <a class="btn btn-success" style="float: right; margin-bottom: 15px;" href="javascript:void(0)" id="createNewProduct"> Create New Product</a>
